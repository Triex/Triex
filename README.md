...
| <img src="arrow.svg" width="20px" height="20px" /> <a href="https://github.com/RakiGuardians">`RakiGuardians`</a><br/><center><i>Helping develop a solidity contract (with some unique tokenomics features)</i></center>  |
| <img src="arrow.svg" width="20px" height="20px" /> <a href="https://github.com/SpaceWormETH">`SpaceWorm`</a><br/><center><i>Helping develop a solidity contract (with instant burn, which deletes tokens<br />from supply/existence, as well as auto-liquidity in-token only, on every transaction) + website</i></center>  |
